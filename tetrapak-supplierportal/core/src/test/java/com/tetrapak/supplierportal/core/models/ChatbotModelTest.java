...
public class ChatbotModelTest {

	@Rule
	public AemContext context = new AemContext();

	/** The Constant RESOURCE_CONTENT. */
	private static final String RESOURCE_CONTENT = "/chatbot/test-content.json";
	...
	public void setUp() throws Exception {
		...
		Class<ChatbotModel> modelClass = ChatbotModel.class;
	...
	public void simpleLoadAndGettersTest() throws Exception {
		assertEquals("", model.getChatbotLink());
