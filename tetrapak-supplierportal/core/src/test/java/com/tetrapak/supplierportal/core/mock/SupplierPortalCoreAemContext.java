...
public class SupplierPortalCoreAemContext {

    private SupplierPortalCoreAemContext() {
        ...
        @Override public void execute(AemContext context) {
            ...
            context.registerAdapter(ResourceResolver.class, UserManager.class,
                    new Function<ResourceResolver, UserManager>() {
                        @Nullable @Override public UserManager apply(@Nullable ResourceResolver resolver) {
