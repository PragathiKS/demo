...
public class LeftNavigationModelTest {
    ...
    public void testGetStartedMessage() {
        ...
        Assert.assertEquals("href", "/content/tetrapak/supplierportal/global/en/dashboard.html", leftNavigationBean.getHref());
        Assert.assertEquals("page name", "sp_dashboard", leftNavigationBean.getPageName());
        ...
        Assert.assertEquals("href", "/content/tetrapak/supplierportal/global/en/ordering/order-history.html", leftNavigationBeanFromSubMenu.getHref());
