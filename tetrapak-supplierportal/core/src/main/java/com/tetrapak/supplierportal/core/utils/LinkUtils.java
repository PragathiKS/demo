...
public class LinkUtils {
	 ...
	 */
	/*
	 * public static String getMarketsRootPath(final String pagePath) { return
	 * Text.getAbsoluteParent(pagePath, PWConstants.MARKET_ROOT_PAGE_LEVEL); }
	 */
	 ...
	 */
	/*
	 * public static String getCountryPath(final String pagePath) { return
	 * Text.getAbsoluteParent(pagePath, PWConstants.COUNTRY_PAGE_LEVEL); }
	 */
	/**
	 ...
	 */
	/*
	 * @Override public void activate() throws Exception { sanitizedLink =
	 * get(PWConstants.PARAM_LINK, String.class);
	 * 
	 * }
	 */
	 ...
	 */
	/*
	 * public String getSanitizedLink() { return
	 * LinkUtils.sanitizeLink(sanitizedLink, getRequest()); }
	 */
	/**
	 * Gets the asset name.
	 *
