...
public class PaymentDetails {
	...
	private String dueCalculationBaseDate;
	...
	public String getAmountInTransactionCurrency() {
		return amountInTransactionCurrency;
	}

	public void setAmountInTransactionCurrency(String amountInTransactionCurrency) {
	...
	public String getDueCalculationBaseDate() {
		return dueCalculationBaseDate;
	}

	public void setDueCalculationBaseDate(String dueCalculationBaseDate) {
	...
	public int[] getPurchasingDocuments() {
