 ...
 * @author Swati Lamba
 */
@ObjectClassDefinition(name = "Azure Table Storage Service Configuration Supplier Portal", description = "Azure Table Storage Service Configuration Supplier Portal")
