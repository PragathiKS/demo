...
/**
 * Auth Checker Servlet performs the authentication and authorization of the
 * user
 *
 * @author Ankit Pathak
 */
@Component(service = Servlet.class, property = { Constants.SERVICE_DESCRIPTION + "=TrS Auth Checker Servlet",
        "sling.servlet.methods=" + HttpConstants.METHOD_HEAD, "sling.servlet.paths=" + "/bin/trs/permissioncheck" })
