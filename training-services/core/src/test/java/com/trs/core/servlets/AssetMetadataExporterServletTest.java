...
class AssetMetadataExporterServletTest {
    ...
    private AssetMetadataExporterServlet assetMetadataExporterServlet;
    ...
    void setUp() throws Exception {
        ...
        assetMetadataExporterServlet = context.registerInjectActivateService(new AssetMetadataExporterServlet(), props);
    }
    ...
    final void testDoGetSlingHttpServletRequestSlingHttpServletResponse() throws ServletException, IOException {
        ...
        request.addRequestParameter("id", "MLV00121");
        assetMetadataExporterServlet.doGet(request, response);
