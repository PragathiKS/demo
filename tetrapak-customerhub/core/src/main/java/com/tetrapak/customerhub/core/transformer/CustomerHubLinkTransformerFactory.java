...
public class CustomerHubLinkTransformerFactory implements TransformerFactory {
    
    
    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerHubLinkTransformerFactory.class);
    ...
    private class CustomerHubLinkRewriterTransformer implements Transformer {
        ...
        private Boolean isValidURL(String url) {
            ...
            if (url.startsWith(CustomerHubConstants.CONTENT_ROOT_PATH)) {
                isValidURL = true;
            }
            return isValidURL;
        }
