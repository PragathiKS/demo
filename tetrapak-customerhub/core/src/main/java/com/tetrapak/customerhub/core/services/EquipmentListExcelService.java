...
public interface EquipmentListExcelService {
    ...
    //boolean generateEquipmentListExcel(SlingHttpServletRequest req, SlingHttpServletResponse response, Equipments equipments);
	boolean generateEquipmentListExcel(SlingHttpServletRequest req, SlingHttpServletResponse response, Results apiResponse);
