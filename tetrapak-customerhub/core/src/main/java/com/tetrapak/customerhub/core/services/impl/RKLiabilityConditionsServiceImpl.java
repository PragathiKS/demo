...
import static com.tetrapak.customerhub.core.constants.CustomerHubConstants.RK_LIABILITY_CONDITIONS_TITLE;
        ...
        if(pdfAssetResource!=null){
            ...
            if(pdfAsset!=null){
                ...
                if(StringUtils.isBlank(assetTitle)){
                    pdfLink.setTitle(RK_LIABILITY_CONDITIONS_TITLE);
                }else{
