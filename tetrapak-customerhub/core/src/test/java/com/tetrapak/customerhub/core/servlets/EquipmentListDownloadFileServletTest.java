...
@RunWith(MockitoJUnitRunner.class) public class EquipmentListDownloadFileServletTest {

    @Mock private Page mockPage;

    @Mock EquipmentListExcelServiceImpl equipmentListExcelService = new EquipmentListExcelServiceImpl();

    @Mock MockEquipmentListApiServiceImpl equipmentListApiService = new MockEquipmentListApiServiceImpl();

    @Mock EquipmentListDownloadFileServlet equipmentListDownloadFileServlet;

    @Mock private ResourceBundleProvider mockResourceBundleProvider;
    ...
    @Rule public final AemContext aemContext = CuhuCoreAemContext.getAemContextWithJcrMock(RESOURCE_JSON, CONTENT_ROOT);
    ...
    @Test public void doGetForExcel() throws IOException {
