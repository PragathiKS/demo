...
public class FinancialsInvoiceDownloadFileServletTest {

	@InjectMocks
	FinancialsInvoiceDownloadFileServlet servlet = new FinancialsInvoiceDownloadFileServlet();
	...
	/**
	 * Test method for
	 * {@link com.tetrapak.customerhub.core.servlets.FinancialsInvoiceDownloadFileServlet#doGet(org.apache.sling.api.SlingHttpServletRequest, org.apache.sling.api.SlingHttpServletResponse)}.
	 * 
	 * @throws IOException
	...
	public void testDoGetSlingHttpServletRequestSlingHttpServletResponse() throws ServletException, IOException {
		...
		Mockito.when(financialsResultsApiService.getFinancialsInvoice("123", "authToken")).thenReturn(apiResp);
	 ...
	 */
	@Test
	public void testDoGetBadreq() throws ServletException, IOException {
