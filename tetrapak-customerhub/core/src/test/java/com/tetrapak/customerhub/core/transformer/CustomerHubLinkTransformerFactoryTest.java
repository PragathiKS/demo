package com.tetrapak.customerhub.core.transformer;

import com.tetrapak.customerhub.core.mock.MockAttributes;
import com.tetrapak.customerhub.core.mock.MockContentHandler;
...
public class CustomerHubLinkTransformerFactoryTest {
    
    /** The context. */
    @Rule
    public final AemContext context = new AemContext(ResourceResolverType.JCR_MOCK);
    
    CustomerHubLinkTransformerFactory customerHubLinkTransformerFactory = new CustomerHubLinkTransformerFactory();
    ...
    public void testMTPTrasformer() throws IOException, SAXException {
        Transformer transformer = customerHubLinkTransformerFactory.createTransformer();
        ...
        assertEquals("CustomerhubLinkTransformerFactoryTest", "CustomerhubLinkTransformerFactoryTest",
                "CustomerhubLinkTransformerFactoryTest");
    }
}
