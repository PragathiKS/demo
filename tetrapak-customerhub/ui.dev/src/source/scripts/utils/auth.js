...
function generateToken() {
  ...
  || $('.tp-my-equipment').attr('data-src_ispublishenvironment') || $('.tp-equipment-details').attr('data-src_ispublishenvironment') || $('.tp-add-equipment').attr('data-src_ispublishenvironment') || $('.tp-aip-licenses').attr('data-src_ispublishenvironment');
  return (
