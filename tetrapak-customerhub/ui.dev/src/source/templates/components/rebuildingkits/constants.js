...
export const RK_MACHINE_SYSTEM = 'machineSystem';
export const RK_SERIAL_NUMBER = 'serialNumber';
export const RK_EQ_STATUS = 'equipmentStatus';
export const RK_NUMBER = 'rkNumber';
export const RK_DESC = 'rkDesc';
export const RK_IMPL_STATUS = 'implStatus';
export const RK_IMPL_DATE = 'implDate';
export const RK_IMPL_STATUS_DATE = 'implStatusDate';
...
export const RK_I18N_IMPL_DATE = 'implDate';
export const RK_I18N_IMPL_STATUS_DATE = 'implStatusDate';
...
export const RK_I18N_ORDER = 'order';

export const RK_I18N_COUNTRY_CODE_TOOLTIP = 'countryToolTip';
export const RK_I18N_LINE_CODE_TOOLTIP = 'functionalLocationToolTip';
...
export const RK_I18N_IMPL_DATE_TOOLTIP = 'implDateToolTip';
export const RK_I18N_IMPL_STATUS_DATE_TOOLTIP = 'implStatusDateToolTip';
export const RK_I18N_GENERAL_NUMBER_TOOLTIP = 'generalRkNumberToolTip';
