(function ($document, gAuthor) {
    ...
    if(isTargetDialog($form,listOfResourceTypes)){
        ...
        patterns = {
            ...
            pardotChinaUrlRegex: /^(http:\/\/)?(go.demo.pardot)*\.[com]{2,5}(:[0-9]{1,5})?(\/.*)?[bvb]$/
        };
		...
		if(dropdownValue==="enableSoftconversion" && !patterns.pardotUrlRegex.test(pardotUrl)) {
            gAuthor.ui.helpers.prompt({
                ...
                message: "Pardot URL for softconversion form cannot be left blank and should start with <b>http://go.demo.pardot.com and end with ddx</b>",
                actions: [{
                    id: "CANCEL",
                    text: "Ok",
			...
			gAuthor.ui.helpers.prompt({
				...
				message: "Pardot URL for subscription form cannot be left blank and should start with <b>http://go.demo.pardot.com and end with ddx</b>",
				actions: [{
					id: "CANCEL",
					text: "Ok",
					className: "coral-Button"
            ...
            gAuthor.ui.helpers.prompt({
                ...
                message: "China Pardot URL for softconversion form cannot be left blank and should start with either <b>http://go.demo.pardot.com and end with bvb</b>",
                actions: [{
                    id: "CANCEL",
                    text: "Ok",
                    className: "coral-Button"
			...
			gAuthor.ui.helpers.prompt({
				...
				message: "China Pardot URL for subscription form cannot be left blank and should start with either <b>http://go.demo.pardot.com and end with bvb</b>",
				actions: [{
					id: "CANCEL",
					text: "Ok",
					className: "coral-Button"
