...
public class NavigationLinksModelTest {
    ...
    public void setUp() throws Exception {
        ...
        final Class<com.tetrapak.publicweb.core.models.megamenucolumnitem.NavigationLinksModel> modelClass = com.tetrapak.publicweb.core.models.megamenucolumnitem.NavigationLinksModel.class;
    ...
    public void testGettersAndSetters() {
        assertEquals(2, model.getNavLinks().size());
    }
}
