...
public class HeaderConfigurationModelTest {
    ...
    private static final String RESOURCE = TEST_CONTENT_ROOT + "/jcr:content/root/responsivegrid/headerconfigurationv2";
    ...
    public void setUp() throws Exception {
        ...
        context.addModelsForClasses(HeaderConfigurationModel.class);
