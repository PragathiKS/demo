...
public @interface DynamicMediaServiceConfig {
    ...
    @AttributeDefinition(name = "Dynamic Media Service Components Configuration Map",
            description = "Dynamic Media Service Components Configuration Map", type = AttributeType.STRING)
