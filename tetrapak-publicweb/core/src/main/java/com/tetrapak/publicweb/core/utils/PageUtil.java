...
public final class PageUtil {
    ...
    public static String getLocaleFromURL (final Page page){
        return page.getLanguage(Boolean.TRUE).toString().concat(PWConstants.HYPHEN).
                concat(page.getAbsoluteParent(PWConstants.COUNTRY_PAGE_LEVEL).
                        getPath().substring(page.getAbsoluteParent(PWConstants.COUNTRY_PAGE_LEVEL).getPath().length() - 2));
    }
