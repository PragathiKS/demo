...
public class SocialLinkBean {
    ...
    public void setSocialMediaLinkPath(String socialMediaLinkPath) {
        this.socialMediaLinkPath = socialMediaLinkPath;
    }

    public String getSocialMediaIconClass() {
        return socialMediaIconClass;
    }
